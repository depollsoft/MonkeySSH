...
import 'package:xterm/src/core/cell.dart' as _i4;
...
class MockEscapeHandler extends _i1.Mock implements _i2.EscapeHandler {
  ...
  @override
  void cursorForwardTab(int? amount) => super.noSuchMethod(
        Invocation.method(
          #cursorForwardTab,
          [amount],
        ),
  ...
  @override
  void cursorBackwardTab(int? amount) => super.noSuchMethod(
        Invocation.method(
          #cursorBackwardTab,
          [amount],
        ),
  ...
  @override
  void setCursorUnderlineStyle(_i4.UnderlineStyle? style) => super.noSuchMethod(
        Invocation.method(
  ...
  @override
  void setCursorOverline() => super.noSuchMethod(
        Invocation.method(
          #setCursorOverline,
          [],
        ),
  ...
  @override
  void unsetCursorOverline() => super.noSuchMethod(
        Invocation.method(
          #unsetCursorOverline,
          [],
        ),
