...
class MonkeyRenderTerminal extends RenderBox
  ...
  MonkeyRenderTerminal({
    ...
    required this._alignToTrailingEdges,
    required this._autoResize,
    required this._resizeTerminalToViewport,
    required this._notifyPixelSizeChanges,
    required this._resizeBottomInset,
    required this._liveOutputAutoScroll,
    required TerminalStyle textStyle,
    required TextScaler textScaler,
    required TerminalTheme theme,
    required this._inlineUnderlines,
    required this._focusNode,
    required this._cursorType,
    this._onEditableRect,
    this._composingText,
    SelectionRegistrar? selectionRegistrar,
  }) : _terminal = terminal,
