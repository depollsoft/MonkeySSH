...
import 'iterm_color_scheme_service_cases.dart';
import 'terminal_osc_color_overrides_cases.dart';

void main() {
  group('terminal_theme_service', () {
    late AppDatabase db;
  ...
  registerItermColorSchemeServiceTests();
  registerTerminalOscColorOverridesTests();
}
