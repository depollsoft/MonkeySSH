...
import 'clipboard_content_service_cases.dart';
import 'remote_clipboard_sync_service_cases.dart';

void main() {
  group('clipboard_sharing_service', () {
    ...
    group('ClipboardSharingService', () {
      ...
      group('decodePayload', () {
        test('decodes valid base64', () {
          ...
          expect(
            ClipboardSharingService.decodePayload(encoded),
            'Hello, World!',
          );
        });
  ...
  registerClipboardContentServiceTests();
  registerRemoteClipboardSyncServiceTests();
}
