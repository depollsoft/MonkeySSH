...
void main() {
  ...
  for (final metadata in [false, true]) {
    test('Windows ${metadata ? 'metadata' : 'versions'} run concurrently and retain separate records', () async {
...
''';
  ...
  test('POSIX metadata requests overlap without mixing records', () async {
