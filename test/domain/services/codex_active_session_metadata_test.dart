...
void main() {
  group('Codex active session identity', () {
    ...
    test(
      ...
      () async {
        ...
        expect(metadata[43]?.sessionId, '22222222-2222-4222-8222-222222222222');
    ...
    test(
      ...
      () async {
        ...
        await File('${probe.home.path}/.codex/logs_2.sqlite')
...
''');
  ...
  Future<void> openRollout(int pid, String id) => File('${home.path}/open-$pid')
      .writeAsString(
