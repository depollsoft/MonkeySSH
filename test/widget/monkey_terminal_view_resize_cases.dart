...
void registerMonkeyTerminalViewResizeTests() {
  group('monkey_terminal_view_resize', () {
    ...
    testWidgets('display refresh re-sends the current viewport dimensions', (
      ...
      terminalKey.currentState!.refreshTerminalDisplay(
    ...
    testWidgets(
      'forceFullRepaint produces a new frame from the current buffer',
      (tester) async {
        final terminal = Terminal();
        final terminalKey = GlobalKey<MonkeyTerminalViewState>();
