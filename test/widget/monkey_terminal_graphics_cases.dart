...
void registerMonkeyTerminalGraphicsTests() {
  group('monkey_terminal_graphics', () {
      ...
      (tester) async {
        ...
        expect(
          await tester.runAsync(
            () => _boundaryPixelCount(boundaryKey, _isBlue),
          ),
          greaterThan(0),
        );
    ...
    testWidgets('reduced motion keeps animated terminal images static', (
      ...
      await tester.runAsync(() async {
        terminal.write(
          '\x1b_Ga=T,i=52,f=100,c=4,r=2;$_animatedGifBase64\x1b\\',
        );
        var waited = 0;
    ...
    testWidgets('live Reduce Motion changes resynchronize terminal playback', (
      ...
      await tester.runAsync(() async {
        terminal.write(
          '\x1b_Ga=T,i=60,f=100,c=4,r=2;$_animatedGifBase64\x1b\\',
        );
        var waited = 0;
    ...
    testWidgets('disabled UI transitions do not pause terminal GIFs', (
      ...
      await tester.runAsync(() async {
        terminal.write(
          '\x1b_Ga=T,i=55,f=100,c=4,r=2;$_animatedGifBase64\x1b\\',
        );
        var waited = 0;
    ...
    testWidgets('animation ticker stops off-screen and resumes when revealed', (
      ...
      await tester.runAsync(() async {
        terminal.write(
          '\x1b_Ga=T,i=54,f=100,c=4,r=2;$_animatedGifBase64\x1b\\',
        );
        var waited = 0;
    ...
    testWidgets(
      'replacing the scroll controller resyncs animation visibility',
      (tester) async {
        final viewKey = GlobalKey<MonkeyTerminalViewState>();
        ...
        await tester.runAsync(() async {
          terminal.write(
            '\x1b_Ga=T,i=59,f=100,c=4,r=2;$_animatedGifBase64\x1b\\',
          );
          var waited = 0;
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        expect(
          ...
          isTrue,
          reason:
              'the placed red image should replace the Unicode placeholders',
        );
      },
    );
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        expect(
          ...
          isNotNull,
          reason:
              'the retained image bytes can back a later placeholder redraw',
        );
      },
    );
    ...
    testWidgets(
      'Kitty placeholder image is dismissed once mostly overwritten',
      (tester) async {
        final boundaryKey = GlobalKey();
        final terminal = Terminal();
    ...
    testWidgets('Kitty placeholder image renders its visible crop with off-screen '
        'scrollback cells retained', (tester) async {
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        await tester.runAsync(() async {
          final png = await _buildSolidPngBase64(const Color(0xFFFF0000), 24);
          terminal.write(
            '\x1b_Ga=T,U=1,i=$imageId,c=8,r=4,f=100,q=2;$png\x1b\\',
          );
    ...
    testWidgets('Kitty placement source crop (x,w) selects the region', (
      ...
      await tester.runAsync(() async {
        ...
        terminal.write(
          '\x1b_Ga=T,i=1,f=100,c=6,r=3,x=0,y=0,w=8,h=16;$png\x1b\\',
        );
        var waited = 0;
    ...
    testWidgets('Kitty source crop scales into a downsampled decoded image', (
      ...
      expect(
        ...
        greaterThan(0),
        reason:
            'the logical right-half crop must render from the decoded image',
      );
      expect(
        await tester.runAsync(() => _boundaryRedPixelCount(boundaryKey)),
        0,
