...
void registerAcpConfigOptionControlsTests() {
  group('acp_config_option_controls', () {
    testWidgets(
    ...
    testWidgets(
      'falls back to legacy mode only when no generic option exists',
      (tester) async {
    ...
    testWidgets('renders unknown option types as a disabled row', (
      tester,
    ) async {
      await _pump(
        tester,
    ...
    testWidgets('dismissing the value picker applies no change', (
      tester,
    ) async {
      final calls = <(String, Object)>[];
      await _pump(
